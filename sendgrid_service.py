...
from settings import (FROM_EMAIL, SG_SANDBOX_MODE, SENDGRID_API_KEY,
         TEMPLATE_ID)
...
class SendgridService:
    ...
    def send_email(self, template_data, recipients, template_id=TEMPLATE_ID):
        if not recipients:
        ...
        sandbox_mode = SandBoxMode(enable=SandBoxMode)
